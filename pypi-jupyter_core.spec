...
Source0  : https://files.pythonhosted.org/packages/20/00/2f3c7b30ca75b36588a3d4e203b909bd15e5c70fd449bf1e2b88fabd55ef/jupyter_core-5.1.1.tar.gz
...
%prep
%setup -q -n jupyter_core-5.1.1
cd %{_builddir}/jupyter_core-5.1.1
pushd ..
cp -a jupyter_core-5.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672331296
