...
Source0  : https://files.pythonhosted.org/packages/9a/d3/b80e7179e9615f5a7f055edc55eb665fa2534f11a4599349db3bab6fdeb5/jupyter_core-5.3.0.tar.gz
...
%prep
%setup -q -n jupyter_core-5.3.0
cd %{_builddir}/jupyter_core-5.3.0
pushd ..
cp -a jupyter_core-5.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679065207
