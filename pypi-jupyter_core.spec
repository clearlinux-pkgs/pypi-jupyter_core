...
Source0  : https://files.pythonhosted.org/packages/c3/de/53a5c189e358dae95d4176c6075127822c9b00193e8d7b1a77003aab253d/jupyter_core-5.7.1.tar.gz
...
%prep
%setup -q -n jupyter_core-5.7.1
cd %{_builddir}/jupyter_core-5.7.1
pushd ..
cp -a jupyter_core-5.7.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704819997
