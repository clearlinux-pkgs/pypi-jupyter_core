...
Version  : 5.1.4
Release  : 77
URL      : https://files.pythonhosted.org/packages/3d/21/f520b9c3460677f2eb4a634c0fb8fd97e1c3a8c32bba3a416a1baf3325e7/jupyter_core-5.1.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/3d/21/f520b9c3460677f2eb4a634c0fb8fd97e1c3a8c32bba3a416a1baf3325e7/jupyter_core-5.1.4.tar.gz
...
%prep
%setup -q -n jupyter_core-5.1.4
cd %{_builddir}/jupyter_core-5.1.4
pushd ..
cp -a jupyter_core-5.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674526233
