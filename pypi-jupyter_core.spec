...
Provides: jupyter_core
Provides: jupyter_core-python
Provides: jupyter_core-python3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641450341
...
cp %{_builddir}/jupyter_core-4.9.1/COPYING.md %{buildroot}/usr/share/package-licenses/pypi-jupyter_core/caf2cfb9faff40412b9975dec725e241814cc46b
