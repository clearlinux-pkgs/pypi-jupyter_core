...
Source0  : https://files.pythonhosted.org/packages/fb/a3/1456f5caa41b37a8ef651227e0c3790436a71672349a50e7938fb3e577cc/jupyter_core-5.1.5.tar.gz
...
%prep
%setup -q -n jupyter_core-5.1.5
cd %{_builddir}/jupyter_core-5.1.5
pushd ..
cp -a jupyter_core-5.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674664557
