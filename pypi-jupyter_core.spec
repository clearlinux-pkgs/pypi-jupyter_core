...
Source0  : https://files.pythonhosted.org/packages/ed/b8/75360f262cc391f3d06d73b1e40d40a4bc7aaf6a4b8b0cb2452ae753c58e/jupyter_core-5.1.2.tar.gz
...
%prep
%setup -q -n jupyter_core-5.1.2
cd %{_builddir}/jupyter_core-5.1.2
pushd ..
cp -a jupyter_core-5.1.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672688777
